            ...
            {[
              {
                ...
                features: ["250g / mois", "1 origine au choix", "Mouture personnalisée", "Livraison offerte"],
                highlight: false,
                badge: null,
              },
              {
                name: "Passion",
                price: "29",
                desc: "Notre formule la plus populaire pour les vrais amateurs.",
                features: ["500g / mois", "2 origines sélectionnées", "Mouture personnalisée", "Livraison offerte", "Notes de dégustation"],
                highlight: true,
              ...
              },
              {
                ...
                features: ["1kg / mois", "Sélection micro-lots", "Mouture personnalisée", "Livraison express 24h", "Notes de dégustation", "Accès aux lots rares"],
                highlight: false,
                badge: null,
              },
            ].map((tier) => (
